<?php
/*Classe TSqlUpdate
*Essa classe provê meios para manipular de uma instruçõa UPDATE
*nos bancos de dados
*/
final class TSqlUpdate extends TSqlInstruction{
private $columnValues;
/*Método setRowData()
*Atrivui valores a determinadas colunas no banco de dados que serão modificadas
*@param $column=coluna da tabela
*@param $value = valor a ser armazenado
*/
public function setRowData($column,$value){
    //verifiaca se um dado é escalar (String,inteiro...)
    if(is_scalar($value)){
